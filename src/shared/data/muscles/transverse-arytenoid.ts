...
export const transverse_arytenoid: MuscleEntry = {
  id: "transverse-arytenoid",
  name: { zh: "杓横肌", latin: "Musculus arytenoideus transversus" },
  category: "head-neck",
  view: ["back"],
  svgPath: {
  ...
  origin: "一侧杓状软骨后外侧面",
  insertion: "对侧杓状软骨后外侧面",
  innervation: "喉返神经 (X)",
  bloodSupply: "甲状腺下动脉",
  primaryActions: ["内收声门（关闭声门后裂）"],
  secondaryActions: ["发声辅助"],
  joints: ["无特定关节"],
    chains: [
    {
