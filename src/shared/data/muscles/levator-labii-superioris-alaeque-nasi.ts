...
export const levator_labii_superioris_alaeque_nasi: MuscleEntry = {
  id: "levator-labii-superioris-alaeque-nasi",
  name: { zh: "提上唇鼻翼肌", latin: "Musculus levator labii superioris alaeque nasi" },
  category: "head-neck",
  view: ["front"],
  svgPath: {
  ...
  bloodSupply: "面动脉",
  primaryActions: ["提上唇", "开大鼻翼"],
  secondaryActions: ["表达厌恶"],
  joints: ["无特定关节"],
    chains: [
    {
    ...
    },
    {
      ...
      downstream: ["levator-anguli-oris", "levator-labii-superioris"],
    },
  ],
  triggerPoints: [],
  interventions: {
