...
export const flexor_hallucis_brevis: MuscleEntry = {
  id: "flexor-hallucis-brevis",
  name: { zh: "拇短屈肌", latin: "Musculus flexor hallucis brevis" },
  category: "lower-limb",
  view: ["front"],
  svgPath: {
    "front": "M170,175 Q200,170 230,175 L230,195 Q200,200 170,195 Z"
  },
  origin: "骰骨/外侧楔骨/足底长韧带/足底腱膜",
  insertion: "拇趾近节趾骨底内侧",
  innervation: "足底内侧神经 (S1-S2)",
  bloodSupply: "足底内侧动脉/足底动脉弓",
  primaryActions: ["拇趾跖趾关节屈曲", "拇趾内收（辅助）"],
  secondaryActions: ["足底蹬地核心"],
  joints: ["跖趾关节"],
    chains: [
    {
