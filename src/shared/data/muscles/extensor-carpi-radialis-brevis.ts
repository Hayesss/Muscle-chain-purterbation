...
export const extensor_carpi_radialis_brevis: MuscleEntry = {
  id: "extensor-carpi-radialis-brevis",
  name: { zh: "桡侧腕短伸肌", latin: "Musculus extensor carpi radialis brevis" },
  category: "upper-limb",
  view: ["back"],
  svgPath: {
  ...
  bloodSupply: "桡返动脉/骨间后动脉",
  primaryActions: ["腕关节伸展", "腕关节外展（桡偏）"],
  ...
  joints: ["腕关节"],
    ...
    },
    {
      ...
      position: "middle",
      upstream: ["abductor-pollicis-longus", "extensor-carpi-radialis-longus"],
