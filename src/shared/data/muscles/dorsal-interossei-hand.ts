...
export const dorsal_interossei_hand: MuscleEntry = {
  id: "dorsal-interossei-hand",
  name: { zh: "手背侧骨间肌", latin: "Musculi interossei dorsales (manus)" },
  category: "upper-limb",
  view: ["front"],
  svgPath: {
  ...
  bloodSupply: "掌深弓/指动脉",
  primaryActions: ["第2-4指外展（以中指为轴）", "掌指关节屈曲", "指间关节伸展（辅助）"],
  secondaryActions: ["手张开", "精细握持"],
  joints: ["掌指关节"],
    chains: [
    {
    ...
    },
    {
      ...
      position: "middle",
      upstream: ["abductor-digiti-minimi", "abductor-pollicis-brevis"],
      downstream: ["adductor-pollicis", "flexor-digiti-minimi-brevis"],
    },
    {
