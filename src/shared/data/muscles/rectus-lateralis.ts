...
export const rectus_lateralis: MuscleEntry = {
  id: "rectus-lateralis",
  name: { zh: "外直肌", latin: "Musculus rectus lateralis" },
  category: "head-neck",
  view: ["front"],
  svgPath: {
  ...
  joints: ["无特定关节"],
    chains: [
    {
      ...
      downstream: ["obliquus-superior-bulbi", "rectus-inferior"],
    },
  ],
  triggerPoints: [],
  interventions: {
