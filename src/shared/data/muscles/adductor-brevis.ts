...
export const adductor_brevis: MuscleEntry = {
  id: "adductor-brevis",
  name: { zh: "短收肌", latin: "Musculus adductor brevis" },
  category: "hip",
  view: ["front"],
  svgPath: {
  ...
  origin: "耻骨下支",
  insertion: "股骨粗线近侧/小转子嵴",
  innervation: "闭孔神经前支 (L2-L4)",
  bloodSupply: "闭孔动脉",
  primaryActions: ["髋关节内收", "髋关节屈曲", "髋关节外旋"],
  ...
  joints: ["髋关节"],
    chains: [
    {
      ...
      position: "middle",
      upstream: ["adductor-longus", "adductor-magnus"],
