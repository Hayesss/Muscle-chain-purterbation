...
export const vastus_medialis: MuscleEntry = {
  id: "vastus-medialis",
  name: { zh: "股内侧肌", latin: "Musculus vastus medialis" },
  category: "hip",
  view: ["front"],
  svgPath: {
  ...
  bloodSupply: "股动脉/膝动脉",
  primaryActions: ["膝关节伸展", "髌骨内侧稳定（VMO）"],
  secondaryActions: ["髌股关节稳定关键"],
  joints: ["膝关节"],
    chains: [
    {
    ...
    },
    {
      ...
      downstream: ["vastus-intermedius", "vastus-lateralis"],
    },
    {
