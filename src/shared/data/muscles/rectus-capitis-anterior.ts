...
export const rectus_capitis_anterior: MuscleEntry = {
  id: "rectus-capitis-anterior",
  name: { zh: "头前直肌", latin: "Musculus rectus capitis anterior" },
  category: "head-neck",
  view: ["front"],
  svgPath: {
  ...
  joints: ["寰枕关节"],
    ...
    {
      chainId: "func_synergy_spinal_flexion",
      position: "middle",
      upstream: ["longus-capitis", "longus-coli"],
    ...
    },
    {
      ...
      position: "middle",
      upstream: ["rectus-capitis-lateralis"],
      downstream: [],
    },
  ],
  triggerPoints: [],
