...
export const scalenus_posterior: MuscleEntry = {
  id: "scalenus-posterior",
  name: { zh: "后斜角肌", latin: "Musculus scalenus posterior" },
  category: "head-neck",
  view: ["front"],
  svgPath: {
  ...
  origin: "C5-C7横突后结节",
  insertion: "第二肋外面",
  innervation: "颈神经前支C6-C8",
  bloodSupply: "颈升动脉",
  primaryActions: ["颈侧屈", "颈旋转", "上提第二肋（辅助吸气）"],
