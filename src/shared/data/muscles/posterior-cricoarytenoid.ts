...
export const posterior_cricoarytenoid: MuscleEntry = {
  id: "posterior-cricoarytenoid",
  name: { zh: "环杓后肌", latin: "Musculus cricoarytenoideus posterior" },
  category: "head-neck",
  view: ["back"],
  svgPath: {
  ...
  innervation: "喉返神经 (X)",
  bloodSupply: "甲状腺下动脉",
  primaryActions: ["外展声门（开大声门裂）"],
  secondaryActions: ["唯一开大声门肌", "呼吸辅助"],
  joints: ["无特定关节"],
    chains: [
    {
