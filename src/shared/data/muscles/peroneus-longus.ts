...
export const peroneus_longus: MuscleEntry = {
  id: "peroneus-longus",
  name: { zh: "腓骨长肌", latin: "Musculus peroneus longus" },
  category: "lower-limb",
  view: ["side"],
  svgPath: {
    "side": "M215,155 Q232,148 238,180 Q232,200 215,195 Z"
  },
  origin: "腓骨外侧面上2/3/胫骨外髁",
  insertion: "内侧楔骨外侧面/第一跖骨底",
  innervation: "腓浅神经 (L5-S1)",
  bloodSupply: "腓动脉/胫前动脉",
  primaryActions: ["足外翻（外展）", "足跖屈（辅助）", "足纵弓外侧支撑（足底腱膜）"],
  secondaryActions: ["步态站立期足稳定", "与胫骨后肌共成足横弓吊带"],
  joints: ["踝关节", "距下关节"],
    chains: [
    {
