...
export const external_urethral_sphincter: MuscleEntry = {
  id: "external-urethral-sphincter",
  name: { zh: "尿道外括约肌", latin: "Musculus sphincter urethrae externus" },
  category: "trunk",
  view: ["back"],
  svgPath: {
  ...
  bloodSupply: "阴部内动脉",
  primaryActions: ["尿道闭合（随意控制）"],
  secondaryActions: ["排尿控制核心"],
  joints: ["无特定关节"],
    chains: [
    {
