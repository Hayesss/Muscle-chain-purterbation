...
export const urethrovaginal_sphincter: MuscleEntry = {
  id: "urethrovaginal-sphincter",
  name: { zh: "尿道阴道括约肌", latin: "Musculus sphincter urethrovaginalis" },
  category: "trunk",
  view: ["back"],
  svgPath: {
  ...
  bloodSupply: "阴部内动脉",
  primaryActions: ["尿道/阴道口紧缩"],
  secondaryActions: ["排尿控制", "性功能"],
  joints: ["无特定关节"],
    chains: [
    {
