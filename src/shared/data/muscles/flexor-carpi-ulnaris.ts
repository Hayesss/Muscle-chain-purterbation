...
export const flexor_carpi_ulnaris: MuscleEntry = {
  id: "flexor-carpi-ulnaris",
  name: { zh: "尺侧腕屈肌", latin: "Musculus flexor carpi ulnaris" },
  category: "upper-limb",
  view: ["front"],
  svgPath: {
    "front": "M175,80 Q200,75 225,80 L225,110 Q200,115 175,110 Z"
  },
  origin: "肱骨内上髁/尺骨鹰嘴/尺骨后缘上2/3",
  insertion: "豌豆骨/钩骨/第五掌骨底",
  innervation: "尺神经 (C7-T1)",
  bloodSupply: "尺动脉",
  primaryActions: ["腕关节屈曲", "腕关节内收（尺偏）", "肘关节屈曲（辅助）"],
  ...
  joints: ["腕关节", "肘关节"],
    ...
    },
    {
      ...
      position: "middle",
      upstream: ["flexor-carpi-radialis", "flexor-digitorum-profundus"],
      downstream: ["flexor-digitorum-superficialis", "flexor-pollicis-longus"],
    },
    {
      chainId: "segment_synergy_C7_T1",
      position: "middle",
      upstream: ["flexor-digitorum-superficialis"],
