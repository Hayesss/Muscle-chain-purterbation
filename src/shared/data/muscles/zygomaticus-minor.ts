...
export const zygomaticus_minor: MuscleEntry = {
  id: "zygomaticus-minor",
  name: { zh: "颧小肌", latin: "Musculus zygomaticus minor" },
  category: "head-neck",
  view: ["front"],
  svgPath: {
  ...
  origin: "颧骨外侧面",
  insertion: "上唇外侧皮肤",
  innervation: "面神经颧支 (VII)",
  bloodSupply: "面动脉",
  primaryActions: ["提上唇外侧（轻微笑）"],
  secondaryActions: ["协助加深鼻唇沟"],
  joints: ["无特定关节"],
    chains: [
    {
