...
export const extensor_pollicis_longus: MuscleEntry = {
  id: "extensor-pollicis-longus",
  name: { zh: "拇长伸肌", latin: "Musculus extensor pollicis longus" },
  category: "upper-limb",
  view: ["back"],
  svgPath: {
  ...
  bloodSupply: "骨间后动脉",
  primaryActions: ["拇指指间关节伸展", "拇指掌指关节伸展", "腕关节伸展/内收（辅助）"],
  secondaryActions: ["拇伸展末端锁定"],
  joints: ["腕关节", "拇指关节"],
    chains: [
    {
    ...
    },
    {
      ...
      downstream: ["extensor-digitorum", "extensor-indicis"],
    },
    {
