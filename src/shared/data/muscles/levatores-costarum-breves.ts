...
export const levatores_costarum_breves: MuscleEntry = {
  id: "levatores-costarum-breves",
  name: { zh: "提肋肌短肌", latin: "Musculi levatores costarum breves" },
  category: "trunk",
  view: ["back"],
  svgPath: {
  ...
  joints: ["肋椎关节/肋横突关节"],
    ...
    },
    {
      ...
      downstream: ["internal-intercostals", "levatores-costarum-longi"],
    },
    {
      chainId: "func_synergy_spinal_lateral_flexion",
      position: "middle",
      upstream: ["erector_spinae", "iliocostalis-lumborum"],
      downstream: ["iliocostalis-thoracis", "levatores-costarum-longi"],
    },
  ],
  triggerPoints: [],
  interventions: {
