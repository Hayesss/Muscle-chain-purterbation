...
export const digastric_anterior_belly: MuscleEntry = {
  id: "digastric-anterior-belly",
  name: { zh: "二腹肌前腹", latin: "Venter anterior musculi digastrici" },
  category: "head-neck",
  view: ["front"],
  svgPath: {
  ...
  joints: ["颞下颌关节"],
    ...
    },
    {
      ...
      downstream: ["chondroglossus", "digastric-posterior-belly"],
    },
  ],
  triggerPoints: [],
  interventions: {
