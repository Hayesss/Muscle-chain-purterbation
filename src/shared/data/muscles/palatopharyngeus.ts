...
export const palatopharyngeus: MuscleEntry = {
  id: "palatopharyngeus",
  name: { zh: "腭咽肌", latin: "Musculus palatopharyngeus" },
  category: "head-neck",
  view: ["front"],
  svgPath: {
  ...
  origin: "腭腱膜咽侧",
  insertion: "甲状软骨板后缘及咽侧壁",
  innervation: "迷走神经咽丛 (X)",
  bloodSupply: "升咽动脉",
  primaryActions: ["降腭帆", "提咽侧壁", "缩咽"],
  secondaryActions: ["吞咽辅助", "发音"],
  joints: ["无特定关节"],
    chains: [
    {
