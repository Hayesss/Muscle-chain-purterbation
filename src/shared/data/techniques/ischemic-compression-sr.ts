...
export const ischemic_compression_sr: TreatmentTechnique = {
  id: "ischemic_compression_sr",
  name: "缺血性压迫 - 缝匠肌扳机点",
  category: "soft_tissue",
  evidenceLevel: "C",
  indications: ["缝匠肌扳机点疼痛", "大腿前内侧酸痛"],
  ...
  targetMuscles: ["sartorius"],
  targetTriggerPoints: ["sr_tp1"],
  targetJoints: [],
  relatedDiagnoses: [],
  relatedResearch: [],
};
