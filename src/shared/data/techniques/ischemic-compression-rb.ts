...
export const ischemic_compression_rb: TreatmentTechnique = {
  id: "ischemic_compression_rb",
  name: "缺血性压迫 - 菱形肌扳机点",
  category: "soft_tissue",
  evidenceLevel: "C",
  indications: ["菱形肌扳机点疼痛", "上背痛", "肩胛骨内侧缘痛"],
  contraindications: ["胸椎骨折", "局部感染"],
  steps: [
