...
export const ischemic_compression_gc: TreatmentTechnique = {
  id: "ischemic_compression_gc",
  name: "缺血性压迫 - 腓肠肌扳机点",
  category: "soft_tissue",
  evidenceLevel: "B",
  indications: ["腓肠肌扳机点疼痛", "小腿抽筋", "晨起僵硬"],
  contraindications: ["深静脉血栓", "局部感染"],
  steps: [
