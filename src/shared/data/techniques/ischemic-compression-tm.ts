...
export const ischemic_compression_tm: TreatmentTechnique = {
  id: "ischemic_compression_tm",
  name: "缺血性压迫 - 小圆肌扳机点",
  category: "soft_tissue",
  evidenceLevel: "C",
  indications: ["小圆肌扳机点疼痛", "肩后痛"],
  ...
  targetMuscles: ["teres_minor"],
  targetTriggerPoints: ["tm_tp1"],
  targetJoints: [],
  relatedDiagnoses: [],
  relatedResearch: [],
};
